      ...
      <div class="d-flex">
        ...
        <div class="mb-9">
          <div class="d-flex align-items-center mb-2">
            <span class="fs-3 fw-bold me-3">{{datas.title}}</span>
            <span class="badge badge-light-success" data-kt-calendar="all_day">{{datas.type}}</span>
          </div>
          <div class="fs-6">{{datas.desc}}</div>
        </div>
      </div>
      <div class="d-flex align-items-center mb-2">
