...
<template>
  <div v-if="asideSecondaryDisplay" class="aside-secondary d-flex flex-row-fluid" @mouseenter="emit('openAside')"
              ...
              <div class="m-0">
                <div class="d-flex mb-10">
                  <div id="kt_header_search" class="d-flex align-items-center w-lg-400px" data-kt-search-keypress="true"
                    ...
                    data-kt-menu-flip="bottom" data-kt-search="true">
                        ...
                        <div class="mb-4" data-kt-search-element="main">
                          <div class="d-flex flex-stack fw-bold mb-5">
                            ...
                            <div class="d-flex" data-kt-search-element="toolbar">
                              ...
                              <div data-kt-search-element="advanced-options-form-show"
                                ...
                                data-bs-toggle="tooltip" title="" data-bs-original-title="Show more search options">
                          ...
                          <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="d-flex align-items-center mb-5">
                              ...
                              <div class="d-flex flex-column">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">"Kept API Project
                                  Meeting</a>
                            ...
                            <div class="d-flex align-items-center mb-5">
                              ...
                              <div class="d-flex flex-column">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">"KPI Monitoring App
                                  Launch</a>
                            ...
                            <div class="d-flex align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                  <span class="svg-icon svg-icon-2 svg-icon-primary">
                                    <inline-svg src="media/icons/duotune/graphs/gra003.svg" />
                                  </span>
                                </span>
                              </div>

                              <div class="d-flex flex-column">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Reference
                                  FAQ</a>
                            ...
                            <div class="d-flex align-items-center mb-5">
                              ...
                              <div class="d-flex flex-column">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">"Landing UI Design"
                                  Launch</a>
                      ...
                      <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                        ...
                        <div class="mb-5">
                          <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                            ...
                            data-select2-id="select2-data-1-r6vx" tabindex="-1" aria-hidden="true">
                            <option value="next" data-select2-id="select2-data-3-rtyr">
                              Within the next
                            </option>
                            ...
                            data-select2-id="select2-data-2-bnkb" style="width: 100%"><span class="selection"><span
                                class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                aria-disabled="false" aria-labelledby="select2-timezone-ek-container"
                                aria-controls="select2-timezone-ek-container"><span class="select2-selection__rendered"
                                  id="select2-timezone-ek-container" role="textbox" aria-readonly="true"
                                  title="Within the next">Within the next</span><span class="select2-selection__arrow"
                        ...
                        <div class="row mb-8">
                          ...
                          <div class="col-6">
                            <select name="date_typer" aria-label="Select a Timezone" data-control="select2"
                              ...
                              class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                              data-select2-id="select2-data-4-hptq" tabindex="-1" aria-hidden="true">
                              <option value="days" data-select2-id="select2-data-6-ez49">
                                Days
                              </option>
                              ...
                              data-select2-id="select2-data-5-c0pc" style="width: 100%"><span class="selection"><span
                                  class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                  role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                  aria-disabled="false" aria-labelledby="select2-date_typer-vk-container"
                                  aria-controls="select2-date_typer-vk-container"><span
                                    class="select2-selection__rendered" id="select2-date_typer-vk-container"
                        ...
                        <div class="d-flex justify-content-end">
                          ...
                          <a href="#" class="btn btn-sm fw-bolder btn-primary"
  ...
  <button v-if="asideSecondaryDisplay && minimizationEnabled"
    ...
    data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="main-minimize"
    style="margin-bottom: 1.35rem" @click="emit('togglePin')">
